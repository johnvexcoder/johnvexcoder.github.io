...
6. Keep the Open Graph and Twitter image URLs pointed at the published 1200×630 card in `src/img/og/portfolio-social-v3.png`. Regenerate it with `node scripts/render-social-preview.cjs` after editing `scripts/social-preview.html`.
